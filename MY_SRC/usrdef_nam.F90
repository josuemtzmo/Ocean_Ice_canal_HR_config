MODULE usrdef_nam
   ...
   REAL(wp), PUBLIC ::   rn_maxz    =    0.  ! max depth                  [m]
...
CONTAINS
   ...
   SUBROUTINE usr_def_nam( cd_cfg, kk_cfg, kpi, kpj, kpk, ldIperio, ldJperio, ldNFold, cdNFtype )
      ...
      !!
      NAMELIST/namusr_def/  rn_domszx, rn_domszy, rn_domszz, rn_dx, rn_dy, rn_dz, rn_maxz, rn_0xratio, rn_0yratio   &
...
902   IF( ios /= 0 )   CALL ctl_nam ( ios , 'namusr_def in configuration namelist' )
      ...
      IF(lwp) THEN
         ...
         WRITE(numout,*) '      max depth                         rn_maxz    = ',   rn_maxz, '  m'
